    ...
    <>
      <section className="flex flex-col mt-20 lg:justify-end font-poppins">
        <div className="w-full backdrop-blur-xl bg-white/30 pt-11 ">
          <div className="justify-center flex-1 max-w-6xl px-4 py-4 mx-auto lg:py-0">
            <div className="flex items-center justify-center pb-3 border-b border-gray-300  lg:justify-between">
              ...
              <div className="flex justify-center ">
                <Link to={"/"} className="mr-6 text-white  hover:text-blue-700">
                  <svg
                ...
                <Link to={"/"} className="mr-6 text-white  hover:text-blue-400">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="16"
                    height="16"
                ...
                <Link to={"/"} className="mr-6 text-white  hover:text-red-600">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="16"
                    height="16"
                ...
                <Link to={"/"} className="mr-6 text-white  hover:text-blue-600">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="16"
                    height="16"
            ...
            <div className="flex flex-wrap py-10 -mx-3">
              ...
              <div className="w-full px-4 md:w-1/4 lg:w-2/12 mb-11 lg:mb-0 text-white">
                <ul>
                  <li className="mb-4">
                    <Link
                      to={"/"}
                  ...
                  <li className="mb-4">
                    <Link className="inline-block text-base font-normal ">
                      Features
                    </Link>
                  </li>
                </ul>
              ...
              <div className="w-full px-4 mb-2 lg:mb-0 md:w-1/3 lg:w-4/12">
                ...
                <div className="flex flex-wrap">
                  <div className="w-full py-1 mb-2 lg:flex-1 lg:py-0 lg:mr-3 lg:mb-0">
                    <input
                      type="email "
                      className="inline-block w-full h-12 px-3 text-black placeholder-gray-700 border rounded-md "
          ...
          {/* <div className="py-6 text-center  text-gray-50">
